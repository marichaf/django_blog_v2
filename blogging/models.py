...
class Post(models.Model):
    ...
    text = models.TextField(
        blank=True
    )  # blank=True means it's ok for the post's body to be empty
    author = models.ForeignKey(
        User, on_delete=models.CASCADE
    )  # ties the User who logs in as the Author.
    ...
    )  # allowing null is how we can tell it hasn't been published yet
